...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rp_sar = findViewById<View>(R.id.rpsar) as Button
    ...
    fun toYEN(v: View?) {
        ...
        Toast.makeText(this, "1 Yen = Rp 115", Toast.LENGTH_SHORT).show()
    }
    ...
    fun toEuro(v: View?) {
        ...
        val hasil = angka * 14000
        hasil_konversi!!.text = NumberFormat.getCurrencyInstance(Locale.GERMANY).format(hasil)
        Toast.makeText(this, "1 Euro = Rp 14000", Toast.LENGTH_SHORT).show()
    }
    ...
    fun toUSD(v: View?) {
        ...
        Toast.makeText(this, "1 U\$D = Rp 14000", Toast.LENGTH_SHORT).show()
    }
    ...
    fun toSAR(v: View?) {
        ...
        val hasil = angka * 4000
        hasil_konversi!!.text = NumberFormat.getCurrencyInstance(Locale.US).format(hasil)
        Toast.makeText(this, "1 Riyal = Rp 4000", Toast.LENGTH_SHORT).show()
    }
}